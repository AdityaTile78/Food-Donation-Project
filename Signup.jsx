...
function Signup() {
  ...
  const navigate = useNavigate();  //UseNavigate is hook used for navigate the page.
  ...
  }, [errors, navigate, values]); //dependency array

  //Design our Signup Page and return the entered values
  return (

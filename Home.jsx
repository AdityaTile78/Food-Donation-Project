              ...
              <div className="row align-items-center">
                ...
                <div className="text-overlay">
                  <h1>
                    ...
                    <strong style={{ color: "#3498db" }}> Annapurna</strong>
                  </h1>
                ...
                <div className="col-md-4 mt-4">
                  <Card>
                    <Card.Body>
                      ...
                      <Card.Text>
                        "I had a wonderful experience using Annapurna. The
                ...
                <div className="col-md-4 mt-4">
                  <Card>
                    <Card.Body>
                      ...
                      <Card.Text>
                        "Annapurna is a fantastic platform that makes it easy
                ...
                <div className="col-md-4 mt-4">
                  <Card>
                    <Card.Body>
                      ...
                      <Card.Text>
                        "The impact of Annapurna is incredible. It's
